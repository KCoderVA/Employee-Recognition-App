...
## 🔄 Detailed Change Analysis (v1.0.6 → v1.1.2)
...
### 2. App.fx.yaml – Core Application Logic
...
### 3. Triage_Screen.fx.yaml – Complete Workflow Redesign
...
### 4. Loading_Screen.fx.yaml – Container Layout Update
...
### 5. Update_Screen.fx.yaml – Container Grid Addition
...
| `App.fx.yaml`                    | 473          | 473          | 0 (no change) |
...
- `v1.1.2.msapp` – Packaged Canvas App for import
- `v1.1.2.zip` – Original download from Power Apps portal
- `.unpacked/` – Full source for version control and review
...
- [README.md](./README.md) – v1.1.2 component documentation
- [app-config.json](./app-config.json) – Application configuration
